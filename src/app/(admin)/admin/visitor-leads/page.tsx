    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      <div className="flex flex-1 flex-col lg:ml-64">
        <header className="sticky top-0 z-20 flex h-16 items-center gap-4 border-b bg-white px-6 shadow-sm">
          ...
          <h1 className="text-xl font-semibold text-slate-800">Visitor Leads</h1>
        </header>
        ...
        <main className="flex-1 p-6">
          <div className="rounded-xl border bg-white shadow-sm">
            ...
            {loading ? (
              ...
              <div className="py-20 text-center text-sm text-slate-500">No leads yet.</div>
            ) : (
                  ...
                  <tbody>
                    {paginated.map((l) => (
                      <tr key={l.id} className="border-b last:border-0 hover:bg-slate-50">
                        ...
                        <td className="px-4 py-3 text-slate-500">{l.contact}</td>
