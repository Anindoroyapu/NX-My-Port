                    ...
                    <div className="postbox__main-wrapper">
                      ...
                      <div className="postbox__details-content-wrapper">
                        ...
                        <p>
                          ...
                          little too small, lay peacefully between its four
                          familiar walls. A collection of textile samples lay
                          spread out on the table - Samsa was a travelling
                          salesman - and above it there hung a picture that he
                              ...
                              <div className="postbox__comment-box d-sm-flex align-items-start">
                                ...
                                <div className="postbox__comment-text ">
                                  ...
                                  <p>
                                    ...
                                    design, code quality, updates etc everything
                                    you needs guys, buy it you won’t regret it!
                                  </p>
