    ...
    <div>
      ...
      <section className="container my-5 py-md-5">
        <div className="col-md-9 col-lg-8 mx-auto text-center">
          <p className="fs-3">
            Alexis Photography Studio based in Portland, Oregon. I specialise in
            shooting liquids and my colourful liquid work, titled “Biford”, has
            become very well known and collectable.
          </p>
        </div>
      </section>
